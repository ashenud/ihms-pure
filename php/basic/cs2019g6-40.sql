...
--
-- Table structure for table `vac_10_14years`
--

CREATE TABLE `vac_10_14years` (
  `baby_id` varchar(50) DEFAULT NULL,
  `approved_doctor_id` varchar(50) DEFAULT NULL,
  `midwife_id` varchar(50) DEFAULT NULL,
  `vac_name` varchar(20) DEFAULT NULL,
...
--
-- Table structure for table `vac_japanese_encephalities`
--

CREATE TABLE `vac_japanese_encephalities` (
  `baby_id` varchar(50) DEFAULT NULL,
  `approved_doctor_id` varchar(50) DEFAULT NULL,
  `midwife_id` varchar(50) DEFAULT NULL,
  `vac_name` varchar(20) DEFAULT NULL,
...
--
-- Indexes for table `vac_10_14years`
--
ALTER TABLE `vac_10_14years`
  ADD KEY `midwife_id` (`midwife_id`),
  ADD KEY `baby_id` (`baby_id`),
  ADD KEY `approved_doctor_id` (`approved_doctor_id`);
...
--
-- Indexes for table `vac_japanese_encephalities`
--
ALTER TABLE `vac_japanese_encephalities`
  ADD KEY `midwife_id` (`midwife_id`),
  ADD KEY `baby_id` (`baby_id`),
  ADD KEY `approved_doctor_id` (`approved_doctor_id`);
...
--
ALTER TABLE `vaccine_date`
  ADD CONSTRAINT `vaccine_date_ibfk_1` FOREIGN KEY (`midwife_id`) REFERENCES `midwife` (`midwife_id`),
  ADD CONSTRAINT `vaccine_date_ibfk_2` FOREIGN KEY (`baby_id`) REFERENCES `baby_register` (`baby_id`);
...
--
-- Constraints for table `vac_10_14years`
--
ALTER TABLE `vac_10_14years`
  ADD CONSTRAINT `vac_10_14years_ibfk_1` FOREIGN KEY (`midwife_id`) REFERENCES `midwife` (`midwife_id`),
  ADD CONSTRAINT `vac_10_14years_ibfk_2` FOREIGN KEY (`baby_id`) REFERENCES `baby_register` (`baby_id`),
  ADD CONSTRAINT `vac_10_14years_ibfk_3` FOREIGN KEY (`approved_doctor_id`) REFERENCES `doctor` (`doctor_id`);
...
--
-- Constraints for table `vac_japanese_encephalities`
--
ALTER TABLE `vac_japanese_encephalities`
  ADD CONSTRAINT `vac_japanese_encephalities_ibfk_1` FOREIGN KEY (`midwife_id`) REFERENCES `midwife` (`midwife_id`),
  ADD CONSTRAINT `vac_japanese_encephalities_ibfk_2` FOREIGN KEY (`baby_id`) REFERENCES `baby_register` (`baby_id`),
  ADD CONSTRAINT `vac_japanese_encephalities_ibfk_3` FOREIGN KEY (`approved_doctor_id`) REFERENCES `doctor` (`doctor_id`);
