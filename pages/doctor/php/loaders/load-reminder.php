...
$query2="SELECT * FROM doctor_reminder WHERE doctor_id='".$doc_id."' order by date_time DESC ";
...
echo '<a data-reminder_id="'.$row2['id'].'" name="submit3" class="del-btn btn text-light">Delete</a>';
echo '</td>';
echo '</tr>';
echo '</form>';
}
