...
<head>
    ...
    <link rel="stylesheet" href="/pages/admin-doctor/css/admin-doc-view-sisters-style.css">
...
<body>
                                    ...
                                    <div class="table-for-data" style="margin-top: 30px">
                                        ...
                                        ?>        
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['sister_division']; ?></td>
                                                    <td>
                                                        <form action="student.php" method="POST">
                                                            <input type="hidden" name="send-msg" value="<?php echo $row['sister_id']; ?>">
                                                            <button type="submit" name="send-btn" class="btn send-btn"><i class="fa fa-eye" aria-hidden="true"></i></button>
                                                        </form>
                                                    </td>
                                                    <td>
                                                        <form action="deleteh.php" method="POST">
                                                            <input type="hidden" name="remove-id" value="<?php echo $row['sister_id']; ?>">
    ...
    <script>
        $(function() {
            $('.inner-sidebar-menu ul li a.a-views').addClass('drop-active');
        });
    </script> 
