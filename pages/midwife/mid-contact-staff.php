                                            ...
                                            <tr>
                                                ...
                                                <th>Send sms</th>
                                                    ...
                                                    include "php/selectdb.php";
                                                        $sql00="SELECT midwife_moh_division FROM midwife WHERE midwife_id='".$_SESSION['midwife_id']."'";
                                                        $take00=mysqli_query($conn,$sql00);
                                                        $row00=mysqli_fetch_assoc($take00);
                                                        $sql01="SELECT doctor_name,doctor_id FROM doctor WHERE doctor_moh_division='".$row00['midwife_moh_division']."'";
                                                    ...
                                                    echo "<input type='text' class='form-control' name='sender' value='".$_SESSION['midwife_id']."' readonly>";
                                                    echo "</div>";
                                                    echo "</div>";
                                                    echo "<div class='row'>";
                                            ...
                                            <tr>
                                                ...
                                                <th>Send sms</th>
                                                    ...
                                                    include "php/selectdb.php";
                                                        ...
                                                        $take00=mysqli_query($conn,$sql00);
                                                        $row00=mysqli_fetch_assoc($take00);
                                                        $sql01="SELECT sister_name,sister_id FROM sister WHERE sister_moh_division='".$row00['midwife_moh_division']."'";
                                                        $take01=mysqli_query($conn,$sql01);
                                                        while($row01=mysqli_fetch_assoc($take01)){
                                                            $sId=$row01['sister_id'];
                                                            echo "<tr>";
                                            ...
                                            <tr>
                                                ...
                                                <th>Send sms</th>
                                                    ...
                                                    include "php/selectdb.php";
                                                        ...
                                                        $take00=mysqli_query($conn,$sql00);
                                                        $row00=mysqli_fetch_assoc($take00);
                                                        $sql01="SELECT midwife_name,midwife_id FROM midwife WHERE midwife_moh_division='".$row00['midwife_moh_division']."'";
                                                        $take01=mysqli_query($conn,$sql01);

                                                        while($row01=mysqli_fetch_assoc($take01)){

                                                            if($row01['midwife_id']==$_SESSION['midwife_id']){
